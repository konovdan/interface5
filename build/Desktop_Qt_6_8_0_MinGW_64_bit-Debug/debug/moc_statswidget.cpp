...
struct qt_meta_stringdata_CLASSStatsWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSStatsWidgetENDCLASS = QtMocHelpers::stringData(
    "StatsWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSStatsWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject StatsWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSStatsWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSStatsWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSStatsWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *StatsWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSStatsWidgetENDCLASS.stringdata0))
